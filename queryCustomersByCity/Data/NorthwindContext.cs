...
namespace Module3Question2.Data
{
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                //you should move it out of source code. You can avoid scaffolding 
                  //  the connection string by using the Name= syntax to read it 
                    //from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148.
                                                   //For more guidance on storing connection
